...
public class MainMenuScreen implements Screen {
    ...
    public MainMenuScreen(DuneTD parent) {
        ...
        backgroundMusic = Gdx.audio.newMusic(Gdx.files.internal("music/arabian_caravan.wav"));
        backgroundMusic.setLooping(true);
        backgroundMusic.play();

        //create switch to mute Music
        Button musicButton = new TextButton("MUTE MUSIC", skin, "small");
        musicButton.setPosition(
                150.0f
                , 10.0f
        );
        //add InputListener to Button, and mute music if Button is clicked
